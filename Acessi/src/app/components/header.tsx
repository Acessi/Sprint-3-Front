                ...
                >
                    ...
                    <div className="flex flex-col place-items-end mr-3">
                        <div className="flex items-center gap-20">
                            ...
                            <a href="login" className="text-lg hover:text-gray-700">Acesse a sua conta</a>
                        </div>
                        <a href="cadastro" className="text-base text-gray-600 hover:text-gray-500">ou cadastre-se grátis</a>
                        ...
                        <div className="flex items-center gap-[57px]">
                            ...
                            <a href="mapaMetro" className="text-lg hover:text-gray-700">Mapa do Metrô/Trem</a>
                        </div>
                            <div className="w-full border-t border-gray-700 my-2"></div>
                        <div className="flex items-center gap-[100px]">    
                            <Image src="/images/falar.png" width={30} height={0}  alt="Ícone para pedir ajuda à Ceci"></Image>
                            <a href="chatCeci" className="text-lg hover:text-gray-700">Falar com a Ceci</a>
                        </div>
                            <div className="w-full border-t border-gray-700 my-2"></div>
                        <div className="flex items-center gap-[140px]">
                            ...
                            <a href="integrantes" className="text-lg hover:text-gray-700">Integrantes</a>
                        </div>
                            <div className="w-full border-t border-gray-700 my-2"></div>
                        <div className="flex items-center gap-[130px]">
                            ...
                            <a href="login" className="text-lg hover:text-gray-700">Desconectar</a>
                        </div>
                            <div className="w-full border-t border-gray-700 my-2"></div>
                    </div>
            </div>            
