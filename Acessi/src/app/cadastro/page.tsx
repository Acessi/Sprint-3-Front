...
export default function AtualizarCadastro() {
  ...
  return (
    <>
      ...
      <p className="text-xl font-bold text-gray-700 text-center mb-4">Preencha os dados abaixo para realizar o seu cadastro</p>
      ...
      <div className="mt-6 flex flex-col items-center justify-center">
        ...
        <div className="w-24 h-24 rounded-full overflow-hidden mt-2 mb-5">
          <Image src="/images/default-user.png" width={100} height={0} alt="Foto de Perfil" className="w-full h-full object-cover"/>
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-gray-700 font-medium mb-2">Digite uma senha</label>
        ...
        <div>
          <label className="block text-gray-700 font-medium mb-2">Confirme a sua senha</label>
        ...
        <div className="text-center mt-4">
          <a href="home" className="inline-block px-6 py-2 bg-green-500 text-white font-bold rounded-md hover:bg-green-600 transition">Cadastrar</a>
        </div>
      </div>
      </form>
      </main>
